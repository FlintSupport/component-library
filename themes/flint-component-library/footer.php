<footer id="footer">
	...
	<div class="bottom">
		<div class="container">
			<p>© Flint Group 2022</p> <?php wp_nav_menu( array( 'theme_location' => 'policy-menu' ) ); ?>
