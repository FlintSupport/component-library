...
function flint_acf_init() {
	if( function_exists('acf_register_block') ) {
		...
		acf_register_block(array(
			...
			'description'		=> __('Provides basic WYSIWYG content section'),
			'render_callback'	=> 'flint_acf_block_render_callback',
			'category'			=> 'flint',
			'icon'				=> 'table-row-before',
			'keywords'			=> array( 'content', 'intro', 'wysiwyg', 'blurb'),
		));
        acf_register_block(array(
			'name'				=> 'accordion',
        ...
        acf_register_block(array(
			...
			'description'		=> __('Devide content and/or media into 2 columns.'),
			'render_callback'	=> 'flint_acf_block_render_callback',
			'category'			=> 'flint',
			'icon'				=> 'align-pull-left',
			'keywords'			=> array( 'split', 'content', 'column', 'paragraph', 'media', 'align'),
		));
        acf_register_block(array(
			'name'				=> 'testimonials',
		...
		acf_register_block(array(
			'name'				=> 'single-column',
			'title'				=> __('Single-Column Image Block'),
