...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Amatic+SC&family=Open+Sans:ital,wght@0,400;0,700;1,400;1,700&display=swap" rel="stylesheet">
	<?php wp_head(); ?>
</head>
<?php
		...
		<div class="container">
			<div class="logo">
				<a href="<?php echo home_url(); ?>">
					<img src="<?php echo get_template_directory_uri(); ?>/img/logo.png" alt="Flint Group Logo" width="182px" height="53px">
				</a>
			</div>
