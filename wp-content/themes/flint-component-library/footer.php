	...
	<div class="container">
		<div class="top">
			<div class="left">
				<div class="container">
					<h2>Footer CTA</h2>
					<img src="http://localhost:10045/wp-content/uploads/2023/04/squareimage.jpg" alt="" />
					<p>Sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna.</p>
					
					<a href="#" target="self">Text Link or Button</a>
				</div>
			</div>
			<div class="right">
				<div class="container">
					<div class="menus">
						...
						<div class="column">
							<h4>Headline</h4>
							<?php if ( has_nav_menu( 'footer-menu-two' ) ) { wp_nav_menu( array( 'theme_location' => 'footer-menu-two' ) ); } ?>
						</div>
						<div class="column">
							<h4>Headline</h4>
							<?php if ( has_nav_menu( 'footer-menu-one' ) ) { wp_nav_menu( array( 'theme_location' => 'footer-menu-one' ) ); } ?>
					...
					<div class="copyright">
						<div class="left">
							<span>Copyright © <?php echo date("Y"); ?> Company Name</span>
						</div>
						<div class="right">
							<?php if ( has_nav_menu( 'policy-menu' ) ) { wp_nav_menu( array( 'theme_location' => 'policy-menu' ) ); } ?>
						</div>
					</div>
				</div>
			</div>
